...
API_TOKEN = '7136371530:AAHaQwotZgasiDg0N1Ydy2ky97G2Wo2oAAU'
ADMIN_ID = '861574272'
...
AUTHORIZED_USERS = [int(ADMIN_ID), 1703515122]  # الأدمن ودوك-جا مسموح لهم دائمًا
...
def process_files(user_id):
    ...
    if os.path.exists(file_path):
        ...
        def process_next_url():
            ...
            if url:
                chapter_number = url.split('/')[-2].replace('-', '.')
                ...
                with concurrent.futures.ThreadPoolExecutor() as executor:
                    ...
                    for img_index, img in enumerate(images):
                        ...
                        if "mangalek.png" not in img_url:
